...
const SuccessStoriesPage = () => {
  const stories = [
    {
      name: "Bella & Ahmed",
      text: "Bella was rescued from the street and now lives happily with Ahmed’s family.",
      tag: "Rescue Story",
    },
    {
      name: "Max & Sarah",
      text: "After months in shelter care, Max finally found his forever home.",
      tag: "Adoption Success",
    },
    {
      name: "Luna & Family",
      text: "Luna brings daily joy, love, and energy to her new family.",
      tag: "Happy Ending",
    },
  ];

  return (
    <section className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-gray-100 py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {stories.map((story, i) => (
            <div
              key={i}
              className="group bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-xl transition duration-300 relative overflow-hidden"
            >
              ...
              {/* decorative glow */}
              <div className="absolute -bottom-10 -right-10 w-32 h-32 bg-orange-100 rounded-full blur-2xl opacity-40 group-hover:opacity-60 transition"></div>
            </div>
          ))}
        ...
        {/* CTA SECTION */}
        <div className="mt-20 bg-orange-50 border border-orange-100 rounded-2xl p-10 text-center">
