      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="mt-3 text-4xl sm:text-5xl font-bold text-gray-900 leading-tight">
            Pet Care <span className="text-orange-600">Tips</span>
          </h1>
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* CARD 1 */}
          <div className="group bg-white border border-gray-100 rounded-2xl p-7 shadow-sm hover:shadow-xl transition duration-300 relative overflow-hidden">

            <div className="text-4xl">💧</div>

            <h2 className="mt-5 text-xl font-semibold text-gray-900 group-hover:text-orange-600 transition">
            ...
            <div className="absolute -bottom-10 -right-10 w-32 h-32 bg-orange-100 rounded-full blur-3xl opacity-40"></div>
